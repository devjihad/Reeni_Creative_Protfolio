        ...
        <div className='container mt-20 md:mt-30 px-5 md:px-0'>
            ...
            <div className='flex flex-col md:flex-row gap-5 md:gap-0 mt-15'>
                ...
                <div className={`py-[34px] px-[38px] rounded-xl mb-5 ${togglevalue? 'bg-cardBG':' bg-[#F4F4F4] border-r-2 border-b-2 border-red1'}`}>
                    ...
                    <p className={`${togglevalue?'text-gray1':'text-gray2'}`}>Business consulting consultants provide expert advice and guida the a <br /> businesses to help theme their performance efficiency</p>
                </div>

                <div className={`py-[34px] px-[38px] rounded-xl mb-5 ${togglevalue? 'bg-cardBG':' bg-[#F4F4F4] border-r-2 border-b-2 border-red1'}`}>
                    <h4 className='mb-[22px] text-[24px] font-rajdhani font-bold'> 02. My Portfolio of Innovation</h4>
                    <p className={`${togglevalue?'text-gray1':'text-gray2'}`}>My work is driven by the belief that thoughtful design and strategic <br /> planning can empower brands, transform businesses</p>
                </div>
                <div className={`py-[34px] px-[38px] rounded-xl mb-5 ${togglevalue? 'bg-cardBG':' bg-[#F4F4F4] border-r-2 border-b-2 border-red1'}`}>
                    <h4 className='mb-[22px] text-[24px] font-rajdhani font-bold'> 03. A Showcase of My Projects</h4>
                    <p className={`${togglevalue?'text-gray1':'text-gray2'}`}>In this portfolio, youll find a curated selection of projects that highlight <br />my skills in Main Areas, e.g., responsive web design</p>
                </div>
