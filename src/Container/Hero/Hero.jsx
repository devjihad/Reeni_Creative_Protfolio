...
const Hero = () => {
    ...
    <div className="container  relative">
         <div >
            ...
            <h2 className="text-[90px] w-175 font-bold tracking-widest text-outline font-rajdhani absolute  top-[67%] left-1/2 -translate-x-1/2 -tranlate-y-1/2 z-30  ">WEB DESIGN</h2><br />
            <h2 className="text-[130px] font-bold tracking-widest text-outline2 font-rajdhani  absolute top-2/3 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">WEBDESIGN</h2>
        </div>
        <div>
            <div className="absolute top-[15%] w-108" >
        ...
        <div className="absolute top-[25%] right-0 w-82.5">
