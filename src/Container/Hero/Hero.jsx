...
const Hero = () => {
    return (
    <div className="container  relative mb-22.5">
         <div >
            <div className="w-170 mx-auto flex justify-center relative z-20 " style={{backgroundImage:`url(${bg})`}} >
                <img src={Mainimage} alt="" className="w-155 h-200  "/>
            </div>
            <h2 className="text-[90px] w-175 font-bold tracking-widest text-outline font-rajdhani absolute  top-169 left-1/2 -translate-x-1/2 -tranlate-y-1/2 z-30  ">WEB DESIGN</h2><br />
            <h2 className="text-[130px] font-bold tracking-widest text-outline2 font-rajdhani  absolute top-169 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">WEBDESIGN</h2>
        </div>
        <div>
            <div className="absolute top-47.75 w-108" >
            <h2 className="text-[70px] font-bold leading-20 font-rajdhani mb-5 z-40"> <span className="text-[28px] font-bold ">HELLO I'M <br /> </span>HOSSEN <br />AHAMMAD</h2>
            <button className="flex items-center gap-2 py-2 px-4 bg-red1 rounded-3xl">View Profile <IoIosArrowRoundForward/></button>
        </div>
        <div className="absolute top-47.75 right-0 w-82.5">
