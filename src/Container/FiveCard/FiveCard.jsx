...
const FiveCard = () => {
    ...
    return (
        <div className='container mt-30 flex flex-col md:flex-row px-5 md:px-0 gap-7.5'>
            <div className={`px-10 pt-9 pb-12.75  md:w-1/2 rounded-xl ${togglevalue? 'bg-cardBG':' bg-[#F4F4F4]'}`}>
                <div className='md:flex gap-16.25 items-center py-5 md:py-9.75 md:pr-12.75'>
            ...
            <div className='  grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-7.5'>
                <div className={`py-8 text-center  md:w-70 h-40.5 rounded-xl ${togglevalue? 'bg-cardBG':' bg-[#F4F4F4] '}`}>
